...
let
  konyakRevision = toString (
    crossoverSource.vkd3dKonyakRevision or crossoverSource.konyakRevision or 0
  );
  version = "crossover-${crossoverSource.version}-vkd3d-1.18-konyak.${konyakRevision}";
  src = fetchurl {
